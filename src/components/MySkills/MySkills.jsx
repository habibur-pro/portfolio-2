...
const MySkills = () => {
    return (
        <div id="skills" className="my-20">
            <h1 className="text-center text-3xl ">My Skills
            </h1>
            <Underline />
            ...
            <div className="grid grid-cols-4 gap-5">
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 duration-300 hover:bg-primary px-5 py-3">
                    <img className="w-12" src={htmlLogo} alt="" />
                ...
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                    <img className="w-12" src={cssLogo} alt="" />
                    <h3 className="text-xl font-bold text-white">CSS</h3>
                </div>
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                    <img className="w-12" src={javascriptLogo} alt="" />
                    <h3 className="text-xl font-bold text-white">Javascript</h3>
                </div>
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                    <img className="w-12" src={bootstrapLogo} alt="" />
                    <h3 className="text-xl font-bold text-white">Bootstrap</h3>
                </div>
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                ...
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                    ...
                    <h3 className="text-xl font-bold text-white">ReactJs</h3>
                </div>
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                ...
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                    ...
                    <h3 className="text-xl font-bold text-white">Express Js</h3>
                </div>
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                ...
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                    <img className="w-12" src={firebaseLogo} alt="" />
                    <h3 className="text-xl font-bold text-white">Firebase</h3>
                </div>
                <div className="flex gap-2 items-center border border-primary hover:-translate-y-2 hover:duration-300 hover:bg-primary px-5 py-3">
                    <img className="w-12" src={nextLogo} alt="" />
